...
Usage: в репозитории есть 2 версии калькулятора - простая(lexer_simple) и расширенная(main). Как можно догадаться, для работы расширенной версии нужен код из functions.
